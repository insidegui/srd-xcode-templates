...
/// Loads a system framework based on its relative path.
/// Works for iOS and iOS Simulator.
/// Example: 'System/Library/PrivateFrameworks/TelephonyUtilities.framework'
